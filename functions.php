...
'show_in_menu'          => true, /* Do not show admin menu */
	...
	add_submenu_page( "edit.php?post_type=job_listing", "Applications", "Applications", 'manage_options', "edit.php?post_type=applications" );
}
add_action('admin_menu', 'applications_submenu');
